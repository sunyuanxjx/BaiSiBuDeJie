...
- (void)setUpAllChildViewController
{
    ...
    // 我
    UIStoryboard *storyboard = [UIStoryboard storyboardWithName:@"BSMineViewController" bundle:nil];
    BSMineViewController *meVc =  [storyboard instantiateInitialViewController];
