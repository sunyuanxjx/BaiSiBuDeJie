...
/*
 ...
 26.搭建登录注册界面，分析层次结构，顶部，输入view,快速登录view。先搞3个view占位，然后往里面填充子控件，方便以后调整位置
 
 27.自定义输入框，一个xib描述两个view
 
 28.自定义快速登录界面
 
 29.处理占位文字颜色，监听文本框
 
 30.runtime解决占位文字颜色，提供分类。
 
 31.我的界面，tableView, 样式：分组样式，界面固定，静态单元格。
 使用storyboard，描述下
